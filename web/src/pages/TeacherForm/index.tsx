...
function TeacherForm() {
	...
	function setScheduleItemValue(position: number, field: string, value: string) {
		const updatedScheduleItems = schedulesItems.map((schedulesItems, index) => {
			if (index === position) {
				return { ...schedulesItems, [field]: value };
			}
				...
				<form onSubmit={handCreateClass}>
					...
					<fieldset>
						...
						<Input
							...
							value={cost}
							onChange={(e) => {seCost(e.target.value) }}
						/>
					</fieldset>
